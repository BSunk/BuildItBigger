...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1363.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.udacity.gradle.backend.myApi.model.JokerBean> {

    private static final String REST_PATH = "jokerbean";
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.gradle.backend.myApi.model.JokerBean.class);
    }
